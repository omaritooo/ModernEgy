<template>
  <client-only>
   ...
   <!-- <l-popup > 
    ...
    <div v-if="!tester">
     <transition name="slide-fade">
       <div class="absolute left-0 z-40 w-full h-full top-64 " v-if="toggle" >
         <div class="relative w-full h-full rounded-lg">
            <div class="absolute z-50 p-4 text-center top-44">
                   To access our online solution you must open it from a computer
           ...
           <div class="absolute left-0 top-4 right-48">
             <div class="flex">
               <div class="text-lg">Projects:</div>
