    ...
    >
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          using Modern Egy, you signify your agreement to be bound by these
          conditions
        </p>
      </div>
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          unique technology that allows the visitor to take a live tour.
        </p>
      </div>
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          feature on the website. If you use Modern Egy Service you are
      ...
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          developer uploads high- resolution images and documents, and all the
          data of the projects and properties are correct, and all the
          information about the real estate company is available. We ensure that
          all the solution is developed to transform all the real estate
          development project’s architectural designs and master plan. We will
          responsible for creating and publishing educated and demo videos to
          explain how to use the website and take a live tour of the projects to
          the website visitors. We will not responsible for any communication or
          procedures between visitors and the real estate companies
        </p>
      </div>
      ...
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          don’t take any commission or percentage of the property purchasing
          happens on the Modern Egy
        </p>
      </div>
      ...
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          development company. Modern Egy doesn't receive any extra fees or
          commissions from the property buyers.
        </p>
      </div>
      ...
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          real estate development companies also we will invite you to attend an
          exhibition or events we will create
        </p>
      </div>
      ...
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          any technical issue in the website you can report it to us by sending
          mail to support@ModernEgy.com
        </p>
      </div>
      ...
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          information, text, photos, graphics, audio files, video, and links,
          ...
          law, Modern Egy disclaims all representations and warranties, express
          or implied, including but not limited to warranties of
          merchantability, fitness for a particular purpose, title, non-
          infringement, freedom from computer virus, and implied warranties
      ...
      <div class="flex flex-col gap-y-5">
        ...
        <p class="text-base text-gray-200 md:text-xl">
          ...
          in accordance with this privacy statement. We may change this policy
          from time to time by updating this page. You should check this page
          from time to time to ensure that you are happy with any changes. Our
          website has secure pages to collect user information and most critical
          data is stored in encrypted form. We use various technical and
          management practices to help protect the confidentiality, security,
          and integrity of data stored on our system. Our servers use Secure
          Sockets Layer (SSL) and encryption technology that works with
          Microsoft Internet Explorer, Firefox, Safari, and Chrome.
        </p>
      </div>
      <div class="flex flex-col gap-y-5">
        <h1 class="text-2xl font-bold text-white md:text-4xl">
